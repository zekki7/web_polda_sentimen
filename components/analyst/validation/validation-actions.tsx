...
interface ValidationActionsProps {
  currentSentiment: 'Positif' | 'Negatif' | 'Netral' | null
  onApprove: () => void
  onReject: () => void
    ...
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          ...
          className="flex-1 px-4 py-3 bg-blue-900/30 text-blue-300 border border-blue-700 rounded-md font-medium hover:bg-blue-900/50 transition-colors flex items-center justify-center gap-2 min-w-0"
        >
          <svg
            className="w-5 h-5"
            fill="none"
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            {sentimentOptions.map((sentiment) => (
              <button
                ...
                className={`flex-1 px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-center gap-2 min-w-0 ${

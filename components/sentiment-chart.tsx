...
export function SentimentChart({ rawData }: SentimentChartProps) {
  ...
  useEffect(() => {
    ...
    setSummary({ peakPositif: pPos, avgNetral: Math.round(tNetral / 7), peakNegatif: pNeg })
  }, [rawData])
